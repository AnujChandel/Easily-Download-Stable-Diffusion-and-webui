...
IF EXIST stable-diffusion-webui (
    echo stable-diffusion-webui Folder is already installed.
) 
...
if /i "%download_file%"=="y" (
 ...
 bitsadmin.exe /transfer "downloading v1-5-pruned.ckpt" https://huggingface.co/runwayml/stable-diffusion-v1-5/resolve/main/v1-5-pruned.ckpt %drive%:\stable-diffusion-webui\models\Stable-diffusion\v1-5-pruned.ckpt

)


cd /d %drive%:\stable-diffusion-webui
