...
if /i "%download_file%"=="y" (
 ...
 bitsadmin.exe /transfer "downloading v1-5-pruned-emaonly.ckpt" https://huggingface.co/runwayml/stable-diffusion-v1-5/resolve/main/v1-5-pruned-emaonly.ckpt %drive%:\stable-diffusion-webui\models\Stable-diffusion\v1-5-pruned-emaonly.ckpt
