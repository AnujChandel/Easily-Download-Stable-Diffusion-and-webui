...
echo,
set /p download_file=Do you want to download "Do you want to download v1-5-pruned.ckpt(7.7GB) now? "? (y/n)
...
rem bitsadmin.exe /transfer "downloading image.exe from " https://go.microsoft.com/fwlink/?LinkID=799445 %drive%:\stable-diffusion-webui-directml\models\Stable-diffusion\image.exe

 bitsadmin.exe /transfer "downloading v1-5-pruned.ckpt" https://huggingface.co/runwayml/stable-diffusion-v1-5/resolve/main/v1-5-pruned.ckpt %drive%:\stable-diffusion-webui-directml\models\Stable-diffusion\v1-5-pruned.ckpt
